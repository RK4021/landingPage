const tl = gsap.timeline({defaults : {duration : .75, ease : "Power3.easeOut"}})

tl.fromTo('.hero-img', {scale : 1.3}, {scale : 1, delay : .35, duration : 2.5, borderRadius : 30, ease: "elastic.out(1.5, 1)"  })
...
tl.fromTo('.cta-button', {scale : 0}, {scale : 1, duration: 2, ease: "elastic.out(1.2, 0.4)"}, "<50%")
...
gsap.fromTo('.letter', {y : 100}, {y : 0, delay : 2, stagger : .1})
